...
- **Google Drive** — owned files you edited (Docs, Sheets, Slides, Word, Excel, PDF, etc.), via the Drive Activity API.
...
- Drive: only files where you are the owner and the last revision was authored by you are included.
